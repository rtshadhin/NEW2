...
module.exports. run = async function({ api, event, args, getText }) {
  ...
  if (!command) {
    ...
    for (let item of returnArray) msg += `무슨 삼촌이야?  ${++i} ❯ ${prefix}${item}\n\n`;
 ...
 /*  var data = ["https://i.imgur.com/aAQ7xey.jpeg", "https://i.imgur.com/aAQ7xey.jpeg", "https://i.imgur.com/aAQ7xey.jpeg", "https://i.imgur.com/aAQ7xey.jpeg", "https://i.imgur.com/aAQ7xey.jpeg"];
...
let path = __dirname + `/cache/help.png`;
  ...
  fs.writeFileSync(path, Buffer.from(image, "utf-8"));*/
    ...
    const text = `😾 BOT X SADU ${arrayInfo.length}\n𝗨𝗦𝗘【 ${prefix}Help 】Ahhhhh.\n╰Ufffffffff🥵 ${page}
╰https://www.facebook.com/linkcopymarao`;
    return api.sendMessage(`😴 USE /HELP1 /HELP2 😴 \n\nPAGE ${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)}` + "\n" + msg + "\n" + text, threadID, async (error, info) => {
      if (autoUnsend) {
